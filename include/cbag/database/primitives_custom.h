 ...
 *
 *  In case user do not have access to OpenAccess Library, these custom primitives will be used.
 *
 *  \author Eric Chang
 *  \date   2018/07/13
 */
...
namespace cbag {
     ...
     */
    enum Orientation {
        R0, R90, R180, R270, MY, MYR90, MX, MXR90
    };
     ...
     */
    enum Font {
        euroStyle, gothic, math, roman, script, stick, fixed, swedish, milSpec
    };
