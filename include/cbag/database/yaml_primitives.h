...
namespace YAML {
    template<>
    struct convert<cbag::Orientation> {
    ...
    template<>
    struct convert<cbag::TermAttrType> {
    ...
    template<>
    struct convert<cbag::TextDispFormat> {
