...
template <> struct polygon_90_set_traits<cbag::layout::polygon90_view> {
    using coordinate_type = cbag::layout::polygon90_view::coordinate_type;
    using iterator_type = cbag::layout::polygon90_view::const_iterator;
    using operator_arg_type = cbag::layout::polygon90_view::operator_arg_type;
