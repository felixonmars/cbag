...
cbag::Orientation convert_orient(const oa::oaOrient &orient) {
  switch (orient) {
    case oa::oacR0:return cbag::Orientation::R0;
    case oa::oacR90:return cbag::Orientation::R90;
    case oa::oacR180:return cbag::Orientation::R180;
    case oa::oacR270:return cbag::Orientation::R270;
    case oa::oacMY:return cbag::Orientation::MY;
    case oa::oacMYR90:return cbag::Orientation::MYR90;
    case oa::oacMX:return cbag::Orientation::MX;
    case oa::oacMXR90:return cbag::Orientation::MXR90;
    default:throw std::invalid_argument("Unknown orientation code.");
  }
}
    ...
    while ((bus_term_ptr = bus_term_iter.getNext()) != nullptr) {
      if (term_list_ptr == nullptr) {
        switch (bus_term_ptr->getTermType()) {
          case oa::oacInputTermType:term_list_ptr = &ans.in_terms;
            break;
          case oa::oacOutputTermType:term_list_ptr = &ans.out_terms;
            break;
          default:term_list_ptr = &ans.io_terms;
        }
      }
  ...
  while ((term_ptr = term_iter.getNext()) != nullptr) {
    ...
    if (tmp_str.index('<') == tmp_str.getLength()) {
      ...
      switch (term_ptr->getTermType()) {
        case oa::oacInputTermType:ans.in_terms.emplace_back(pin_name);
          break;
        case oa::oacOutputTermType:ans.out_terms.emplace_back(pin_name);
          break;
        default:ans.io_terms.emplace_back(pin_name);
      }
    }
  }
