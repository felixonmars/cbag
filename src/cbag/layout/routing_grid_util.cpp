...
offset_t get_line_end_space_htr(const routing_grid &grid, direction vdir, level_t level,
                                cnt_t ntr) {
...
em_specs_t get_via_em_specs(const routing_grid &grid, direction vdir, level_t level,
