...
namespace phonenix = boost::phoenix;

int
main() {

    auto range = qi::uint_parser | (qi::uint_parser >> ':' >> qi::uint_parser) |
            (qi::uint_parser >> ':' >> qi::uint_parser >> ':' >> qi::uint_parser);

    auto nunit = qi::literal_string
